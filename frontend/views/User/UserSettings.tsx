...
export const UserSettings: React.FC = () => {
  ...
  return (
    <div className="pb-16 space-y-6">
      <div className="px-2">
        <h1 className="text-3xl md:text-[2rem] font-semibold text-[#2E2E2F] dark:text-white tracking-tight uppercase">{activeTabMeta.label}</h1>
        <p className="mt-1 text-sm font-semibold text-[#2E2E2F] dark:text-white/60">{activeTabMeta.description}</p>
      </div>
      <div>
